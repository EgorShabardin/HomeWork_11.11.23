...
{
    /// <summary>
    /// Класс, реализующий шифровку и дешифровку строк посредством сдвига каждого символа на одну алфавитную позицию выше.
    /// </summary>
    class ACipher : ICipher
    {
        ...
        #region Конструкторы
        /// <summary>
        /// Конструктор, позволяющий создать экземпляр класса ACipher.
        /// </summary>
